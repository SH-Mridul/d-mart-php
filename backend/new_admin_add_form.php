...
<body class="day-mode">
    ...
    <!-- Dashboard Wrapper to Center the Content -->
     <h2 class="dashboard-title mt-4">New Admin Account Settings</h2>
    <div class="dashboard-wrapper">
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-12 mb-4">
                    <div class="card card-form p-4">
                        <h5 class="card-title text-center text-light">New Admin Information Form</h5>
                        <form class = "text-light p-4 m-4" method ="post" action="new_admin_add.php">
