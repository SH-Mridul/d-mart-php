<?php 
    ...
    if (isset($_GET['id']) && !empty($_GET['id'])) {
        ...
        $sql = "SELECT name FROM categories WHERE id = ? AND status = 1";
        ...
        if ($result->num_rows > 0) {
            ...
            header("Location: categories.php"); // Redirect to brand list page
            exit();
        }
...
<body class="day-mode">
    ...
    <h2 class="dashboard-title mt-4">Update Category</h2>
    <div class="dashboard-wrapper">
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-12 mb-4">
                    <div class="card card-form p-4">
                        <h5 class="card-title text-center text-light">Update Category Information Form</h5>
                        <form class="text-light p-4 m-4" method="post" action="update_category.php">
