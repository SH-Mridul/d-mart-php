...
<body class="day-mode">
    ...
    <h2 class="dashboard-title mt-4">Add New Product</h2>
    <div class="dashboard-wrapper">
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-12 mb-4">
                    <div class="card card-form p-4">
                        <h5 class="card-title text-center text-light">New Product Information Form</h5>
                        <form class="text-light p-4 m-4" method="post" enctype="multipart/form-data" action="new_product_add.php">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="categorySelect" style ="width:100%">
                                        <?php
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                echo "<li><input type='checkbox' class='form-check-input category-option' name='category[]' value='{$row['id']}'> <label class='form-check-label'>{$row['name']}</label></li>";
                                            }
                                        ?>
                                    </ul>
                                </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="sizeSelect" style="width:100%">
                                        <?php
                                            ...
                                            $result = $conn->query($query);
                                            while($row = $result->fetch_assoc()) {
                                                echo "<li><input type='checkbox' class='form-check-input size-option' name='size[]' value='{$row['id']}'> <label class='form-check-label'>{$row['name']}</label></li>";
                                            }
                                        ?>
                                    </ul>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="file" class="form-control form-control-sm" name="product_image" id="product_image" accept="image/*" required>
