...
<body class="day-mode">
    ...
    <h2 class="dashboard-title mt-4">Brands</h2>
    <div class="container">
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>
                                                <a href='edit_brand.php?id=" . $row['id'] . "' class='btn btn-success btn-sm'>Edit</a>
                                                <a href='delete_brand.php?id=" . $row['id'] . "' 
                                    ...
                                    echo "<tr><td colspan='3' class='text-center'>No brands available</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
